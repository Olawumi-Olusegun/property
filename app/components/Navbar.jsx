...

                {
                  isProfileMenuOpen && (
                      ...
                      >
                          <Link
                          href='/profile'
                          className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 transition-colors duration-300 '
                          role='menuitem'
                          tabIndex='-1'
                          id='user-menu-item-0'
                          ...
                          <button
                          type='button'
                          className='block w-full text-start px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 transition-colors duration-300'
                          role='menuitem'
                          tabIndex='-1'
                          id='user-menu-item-2'
